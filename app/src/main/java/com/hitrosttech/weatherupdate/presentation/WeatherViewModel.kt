...
import com.hitrosttech.weatherupdate.domain.location.LocationTracker
	...
	fun loadWeatherInfo() {
		viewModelScope.launch {
			...
			locationTracker.getCurrentLocation()?.let {
				...
				state = state.copy(
					isLoading = false,
					error = "Couldn't retrieve location, grant location permission and enable location tracking."
				)
			}
		}
	}
